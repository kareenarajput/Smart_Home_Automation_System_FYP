...
class Kitchen extends StatefulWidget {
  ...
  @override
  KitchenState createState() => KitchenState();
}

class KitchenState extends State<Kitchen> {
  List<Appliance> appliances = [
    const Appliance(
      ...
      customText: "1",// Use built-in icon
    ),
    const Appliance(
      name: "Fan",
      powerConsumption: 0,
    ...
    const Appliance(
      ...
      powerConsumption: 0,
      isOn: false,
      icon: Icons.kitchen_outlined, // Use built-in icon
      customText: "1",
    ),
    const Appliance(
      name: "Exhaust Fan",
      powerConsumption: 1100,
      isOn: true,
      icon: Icons.air, // Use built-in icon
      customText: "1",
    ),
    const Appliance(
      name: "Dispenser",
      powerConsumption: 0,
      isOn: false,
      icon: Icons.water_drop_outlined, // Use built-in icon
      customText: "1",
    ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("  Kitchen",style: TextStyle(color: Colors.white)),
