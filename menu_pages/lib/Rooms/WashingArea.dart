...
class WashingArea extends StatefulWidget {
  const WashingArea({super.key});

  @override
  WashingAreaState createState() => WashingAreaState();
}

class WashingAreaState extends State<WashingArea> {
  List<Appliance> appliances = [
    ...
    const Appliance(
      ...
      powerConsumption: 0,
      isOn: false,
      icon: Icons.local_laundry_service_outlined, // Use built-in icon
      customText: "1",
    ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("  Washing Area",style: TextStyle(color: Colors.white)),
